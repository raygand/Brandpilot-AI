...
# 1. Add buyerQuestions, roadmapTemplates, wowComputing, wowClose, wowUnit to each language section
# We'll insert after the wowReady line in each section

# TH buyerQuestions
th_buyer = """    wowReady: 'พร้อมใช้งาน!',
...
# 2. Fix setLanguage to not crash if applyTranslations doesn't exist
content = content.replace(
    "  applyTranslations();",
    "  if (typeof window.applyTranslations === 'function') window.applyTranslations();"
)

# 3. Export currentLang as well (already exported)
# Check the export line
if "export { I18N, currentLang, setLanguage, t }" in content:
